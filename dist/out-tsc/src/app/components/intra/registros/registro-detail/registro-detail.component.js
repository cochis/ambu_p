...
var RegistroDetailComponent = /** @class */ (function () {
    function RegistroDetailComponent(_registroService, _sharedService, _route, _router, _empleadoService, _ambulanciasService) {
    ...
    RegistroDetailComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    RegistroDetailComponent.prototype.ngOnChanges = function () {
    ...
    RegistroDetailComponent.prototype.onSubmit = function (form) {
        var _this = this;
    ...
    RegistroDetailComponent.prototype.show = function (mes) {
        this.msgs.push({ severity: 'info', summary: 'Info Message', detail: 'PrimeNG rocks' });
    };
    RegistroDetailComponent.prototype.hide = function () {
        this.msgs = [];
    };
    RegistroDetailComponent.prototype.mueveReloj = function () {
        this.momentoActual = new Date();
    ...
    RegistroDetailComponent.prototype.confirmacion = function () {
        this.actualizar = true;
    };
    RegistroDetailComponent = tslib_1.__decorate([
        Component({
    ...
    return RegistroDetailComponent;
}());
export { RegistroDetailComponent };
//# sourceMappingURL=registro-detail.component.js.map